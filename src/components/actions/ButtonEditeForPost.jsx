...
export default function ButtonEditeForPost(replacedData) {
  return (
    <Popup
      ...
      trigger={<button className="cardButton px-4">Edit</button>}
      modal
      nested
    >
      {(close) => (
        <Row className="popupAction d-flex justify-content-center p-3">
          ...
          <Row className="actions d-flex justify-content-end mt-4">
            <Col className="d-flex justify-content-end">
              <button type="submit" onClick={replacedData}  className="cardButton mx-3 px-3">
                Edit user
              </button>
              <button
